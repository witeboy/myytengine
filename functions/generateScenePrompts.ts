...
const styleMap = {
  ...
  humpty_dumpty: {
    positive: "Minimalist stick-figure cartoon illustration style, simple round white circle heads with thick dark brown outlines, tiny dot eyes and simple curved line mouths for expressions (happy smile, sad frown, angry V-brows, surprised O-mouth, smirk), bean-shaped or egg-shaped bodies with stick limbs, flat solid-color clothing with no shading (dark slate jackets, brown coats, red robes, beige shirts, blue uniforms), warm cream/beige solid background (#F5E6D3), thick consistent dark brown outlines on all drawn elements, extremely minimal detail, no gradients, no shadows, no textures on characters, hand-drawn wobbly line quality, characters distinguished by clothing color and simple accessories (hats, ties, hair), occasionally mixed with photorealistic objects placed beside the simple drawn characters for comedic contrast, clean digital illustration, muted earth-tone palette (cream, brown, slate, muted red, olive green, dusty blue)",
    reinforcement: "STYLE LOCK: simple stick-figure cartoon, white circle heads, thick dark brown outlines, flat solid colors, warm cream background, minimal detail, bean-shaped bodies, NO shading on characters, NO gradients, hand-drawn quality, muted earth tones. Characters are EXTREMELY simple — just circles for heads with dot-eyes and line-mouths, egg/bean bodies with stick arms and legs. Think 'crudely drawn in a charming way'. Background is ALWAYS a solid warm cream color unless a specific location is needed (then draw it in the same minimal style). When real-world objects appear, they are photorealistic while characters remain simple drawn figures.",
    antiStyle: "NOT photorealistic characters, NOT detailed faces, NOT anime, NOT 3D rendered, NOT realistic humans, NOT complex shading, NOT gradient fills on characters, NOT busy detailed backgrounds. Simple stick-figure cartoon only. Characters must NEVER have realistic facial features, detailed hair rendering, or complex body anatomy.",
    negative: "photorealistic people, realistic faces, detailed anatomy, anime, 3D render, CGI, complex shading, gradient, detailed background, intricate, busy, complex, volumetric lighting, realistic skin, realistic hair, depth of field on characters, motion blur on characters"
  }
};
