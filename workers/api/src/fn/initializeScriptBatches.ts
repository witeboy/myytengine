// Ported from the original hosted initializeScriptBatches function
...
async function callOpenAI(ctx, prompt, temperature = 0.7, retries = 3) {
...
- CTA Style: ${strat.cta_style || strat.cta || 'N/A'}\n`;
    ...
    const outlineResult = await callOpenAI(ctx, outlinePrompt, temperature);
