/**
 * ClipExtractor.jsx  —  Refactored: zero base44 integration dependencies
 *
 * Replaces:
 *   base44.integrations.Core.UploadFile  →  uploadToCloudinary (directApi)
 *   base44.functions.invoke('analyzeViralMoments') →  analyzeViralMoments (directApi / Claude direct)
 *   transcribeVoiceover (base44 backend) →  transcribeFile (directApi / AssemblyAI direct)
 *
 * YouTube URL path: Cobalt audio extraction → AssemblyAI transcription → Claude analysis
 * File path: Cloudinary upload → AssemblyAI transcription → Claude analysis → FFmpeg clip
 */
