...
import CaptionPreview, { drawCaptions } from './CaptionPreview';
...
import {
  ...
  Zap, Search, Play, Copy, ChevronDown, ChevronUp,
  Smartphone, Monitor, Shield, Gamepad2,
} from 'lucide-react';
...
export default function ClipEnhancePanel({ clip, words, videoUrl, onClose }) {
