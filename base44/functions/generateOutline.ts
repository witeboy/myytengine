...
{"storytelling_format": "${contentType}", "batches": [{"batch_number": 1, "story_segment": "Short title (3-5 words)", "focus_area": "Brief focus (1 sentence)", "target_words": ${wordsPerBatch}, "synopsis": "EXTREMELY DETAILED synopsis (200-300 words) describing the ACTUAL soothing content."}]}`;
      ...
      const STORY_ARCH_CONFIGS = {
        ...
        story_mystery: {
          ...
          phaseGuide: 'Phase 1: The puzzle posed — specific, concrete, seemingly impossible. Phase 2: First clues — establish the detective's method. Phase 3: Red herrings that feel real. Phase 4: Narrowing — truth emerges. Phase 5: Revelation — surprising but inevitable. Phase 6: Resolution.',
          synopsisRules: 'Synopses must list the CLUES planted and RED HERRINGS introduced in each section. Map what the reader is meant to conclude (wrong) vs what is actually true. Every detail planted must be either a clue or a red herring — nothing is filler in a mystery.',
        },
        story_adventure: {
          label: 'Adventure',
